...
def main():
    ...
    blocks = [
        ("Grey_Floor", _rel(0, 0, -50), unreal.Vector(34, 8, 1), floor),
        ("Grey_WallLeft", _rel(0, -450, 400), unreal.Vector(34, 1.5, 10), wall),
        ("Grey_WallRightA", _rel(-1050, 450, 400), unreal.Vector(13, 1.5, 10), wall),
        ("Grey_WallRightB", _rel(900, 450, 400), unreal.Vector(16, 1.5, 10), wall),
        ("Grey_WallBack", _rel(-1400, 0, 400), unreal.Vector(1.5, 10, 10), (0.20, 0.18, 0.16)),
        ("Grey_WallFrontL", _rel(1600, -280, 350), unreal.Vector(1.2, 4, 8), (0.22, 0.20, 0.17)),
        ("Grey_WallFrontR", _rel(1600, 280, 350), unreal.Vector(1.2, 4, 8), (0.22, 0.20, 0.17)),
        ...
        ("Grey_Step1", _rel(1200, 0, 20), unreal.Vector(2.5, 3, 0.6), step),
        ("Grey_Step2", _rel(1320, 0, 70), unreal.Vector(2.5, 3, 0.6), step),
        ("Grey_Step3", _rel(1440, 0, 120), unreal.Vector(2.5, 3, 0.6), step),
        ("Grey_Ledge", _rel(1580, 0, 160), unreal.Vector(4, 4, 0.7), (0.20, 0.18, 0.15)),
